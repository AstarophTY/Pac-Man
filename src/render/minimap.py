...
from ursina import Entity, camera, color as colors, duplicate
...
class MiniMap(Entity):
    def __init__(self, walls, size, scale):
        ...
        self.minimap_walls.color = colors.rgb(0.729, 0.980, 1.000)
        ...
        Entity(
            parent=self,
            model='quad',
            color=colors.rgba(0.020, 0.031, 0.063, 0.74),
        ...
        Entity(
            parent=self,
            model='quad',
            color=colors.rgba(0.322, 0.824, 1.000, 0.36),
            scale=(inner_w, 0.005),
            position=(
        ...
        self.bg = Entity(
            parent=self,
            model='quad',
            color=colors.rgba(0.071, 0.098, 0.169, 0.84),
        ...
        self._title = Entity(
            parent=self,
            model='quad',
            color=colors.rgba(0.110, 0.161, 0.251, 0.82),
